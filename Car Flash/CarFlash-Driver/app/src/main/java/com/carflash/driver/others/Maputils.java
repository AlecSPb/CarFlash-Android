...
public class Maputils {
    ...
    public static Marker setDestinationmarker(Context context, GoogleMap mMap, LatLng markerLatLng, String destination_name){
        View marker = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(com.carflash.driver.R.layout.destination_marker_layout, null);
        TextView destination_txt = (TextView) marker.findViewById(com.carflash.driver.R.id.destination_txt);
