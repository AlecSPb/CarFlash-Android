...
import com.carflash.driver.adapter.CarAdapter;
import com.carflash.driver.adapter.CarModelAdapter;
import com.carflash.driver.adapter.CityAdapter;
import com.carflash.driver.models.ResultCheck;
import com.carflash.driver.models.carmodels.CarModels;
import com.carflash.driver.models.register.Register;
import com.carflash.driver.models.viewcartype.ViewCarType;
import com.carflash.driver.models.viewcity.ViewCity;
import com.carflash.driver.others.ImageCompressMode;
...
public class RegisterActivity extends AppCompatActivity implements ApiManager.APIFETCHER {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phone_ccp= (CountryCodePicker) findViewById(R.id.phone_ccp);
...
//        });
        ...
        ll_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (txt_phone_signup.getText().toString().trim().equals(""))
                {
    ...
    private void cretaDriverAccount(String name, String email, String password, String city_id, String car_id, String car_model_id, String carNumber, String ride_cat_id, String bank_name, String account_number, String account_name) {
       phoneNumber=phone_ccp.getSelectedCountryCodeWithPlus()+txt_phone_signup.getText().toString().trim();
