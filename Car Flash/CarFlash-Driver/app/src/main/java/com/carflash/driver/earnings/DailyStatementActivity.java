package com.carflash.driver.earnings;
...
import com.carflash.driver.SelectedRentalRideActivity;
import com.carflash.driver.SelectedRidesActivity;
import com.carflash.driver.manager.SessionManager;
import com.carflash.driver.models.restmodels.NewDriverReportModel;
import com.carflash.driver.newmodels.DailyEarningModel;
...
public class DailyStatementActivity extends Activity implements ApiManager.APIFETCHER {
    ...
    @Bind(com.carflash.driver.R.id.trip_container)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.carflash.driver.R.layout.activity_daily_statement);
        ButterKnife.bind(this);

        apiManager = new ApiManager(this);
        sessinManager = new SessionManager(DailyStatementActivity.this);
        pd = new ProgressDialog(this);
        pd.setMessage("" + this.getResources().getString(com.carflash.driver.R.string.loading));
        ...
        backBtnLL = (LinearLayout) findViewById(com.carflash.driver.R.id.backBtnLL);
        totalEarningTV = (TextView) findViewById(com.carflash.driver.R.id.totalEarningTV);
        totalRidesTV = (TextView) findViewById(com.carflash.driver.R.id.totalRidesTV);
        totalEarningTV1 = (TextView) findViewById(com.carflash.driver.R.id.totalEarningTV1);
        headDateTV = (TextView) findViewById(com.carflash.driver.R.id.headDateTV);
        faredEarnedTV = (TextView) findViewById(com.carflash.driver.R.id.faredEarnedTV);
        companyTaxTV = (TextView) findViewById(com.carflash.driver.R.id.companyTaxTV);

        online_time = (TextView) findViewById(com.carflash.driver.R.id.online_time);
        overall_rating = (TextView) findViewById(com.carflash.driver.R.id.overall_rating);
        acceptance_rate = (TextView) findViewById(com.carflash.driver.R.id.acceptance_rate);
...
//        }
    ...
    public View getTripItemView(final String ride_id, String date, String amount , final String ride_mode) {
        View child = getLayoutInflater().inflate(com.carflash.driver.R.layout.trip_item, null);
        TextView trip_no_txt = (TextView) child.findViewById(com.carflash.driver.R.id.trip_no_txt);
        TextView amount_txt = (TextView) child.findViewById(com.carflash.driver.R.id.amount_txt);
        TextView date_txt = (TextView) child.findViewById(com.carflash.driver.R.id.date_txt);
