...
public class EarningActivity extends FragmentActivity implements ApiManager.APIFETCHER, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.carflash.driver.R.layout.activity_earning);
        ...
        dateTV = (TextView) findViewById(com.carflash.driver.R.id.dateTV);
        totalSummaryTV = (TextView) findViewById(com.carflash.driver.R.id.totalSummaryTV);
        container = (FrameLayout) findViewById(com.carflash.driver.R.id.container);

        findViewById(com.carflash.driver.R.id.viewFullSummLL).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(com.carflash.driver.R.id.backBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(com.carflash.driver.R.id.another_week_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (weeklyEarningModel.getResult() == 1) {
                        ...
                        for (int i = 0; i < weeklyEarningModel.getDetails().size(); i++) {
                            ...
                            dateTV.setTextColor(this.getResources().getColor(com.carflash.driver.R.color.icons_8_muted_yellow));
                        }

                        getSupportFragmentManager()
                                .beginTransaction()
                                .add(com.carflash.driver.R.id.container, FragmentGraph.newInstance("message" , ""+script), "rageComicList")
                                .commit();
