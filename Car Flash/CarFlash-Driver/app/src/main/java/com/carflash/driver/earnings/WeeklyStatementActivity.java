...
import com.carflash.driver.newmodels.WeeklyEarningModel;
...
public class WeeklyStatementActivity extends Activity implements ApiManager.APIFETCHER {
    ...
    @Bind(com.carflash.driver.R.id.backBtnLL)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.carflash.driver.R.layout.activity_weekly_statement);
...
//        }
        ...
        completedTripsTV = (TextView) findViewById(com.carflash.driver.R.id.completedTripsTV);
        fareEarnedTV = (TextView) findViewById(com.carflash.driver.R.id.fareEarnedTV);
        taxiFeeTV = (TextView) findViewById(com.carflash.driver.R.id.taxiFeeTV);
        bonusTV = (TextView) findViewById(com.carflash.driver.R.id.bonusTV);
        textView4 = (TextView) findViewById(com.carflash.driver.R.id.textView4);
        weekDatesTV = (TextView) findViewById(com.carflash.driver.R.id.weekDatesTV);
    ...
    public View getTripItemView(String day_date, String amount, final String date, final Context context) {
        View child = getLayoutInflater().inflate(com.carflash.driver.R.layout.week_day_item, null);
        final TextView day_date_txt = (TextView) child.findViewById(com.carflash.driver.R.id.day_date_txt);
