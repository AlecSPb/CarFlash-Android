...
import com.carflash.driver.earnings.EarningActivity;
...
import com.carflash.driver.manager.DeviceManager;
...
import com.carflash.driver.models.ActiveRidesResponse;
import com.carflash.driver.models.CallSupportResponse;
import com.carflash.driver.models.ModelReportIssue;
import com.carflash.driver.models.ModelScheduleAndunacceptedRide;
import com.carflash.driver.models.ResultCheck;
import com.carflash.driver.models.deviceid.DeviceId;
import com.carflash.driver.models.restmodels.NewHeatmapModel;
import com.carflash.driver.models.restmodels.NewUpdateLatLongModel;
import com.carflash.driver.others.Constants;
import com.carflash.driver.others.FirebaseUtils;
...
//                Intent i = new Intent();
//                i.setClassName("com.apporio.driver", "TrialReceivePassengerActivity");
//                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                i.putExtra(""+Config.IntentKeys.RIDE_ID, ride_id);
//                startActivity(i);
//            } else if (ride_status.equals("2")) {
//                Intent i = new Intent();
//                i.setClassName("com.apporio.driver", "RidesActivity");
//                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                startActivity(i);
...
//                Intent i = new Intent();
//                i.setClassName("com.apporio.driver", "ReceiveRentalPassengerActivity");
//                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                i.putExtra(""+Config.IntentKeys.RIDE_ID, ride_id);
//                startActivity(i);
//            }
